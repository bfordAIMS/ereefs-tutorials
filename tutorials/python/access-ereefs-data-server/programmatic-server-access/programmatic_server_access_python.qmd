...
import csv # to read comma separated values (.csv) files
...
# Read in data
loggerhead_data = csv.reader("data/Loggerhead_Sea_Turtle_satellite_tracking_detections__Strydom_2022_DOI10-15468-k4s6ap.csv")
